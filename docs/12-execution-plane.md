...
The execution plane's first node: ace-exec running receptor from the release binary, TLS-peered to the control node — a real AAP-style execution plane, built by hand. (Same plane, different members later: Kubernetes via container groups.)
